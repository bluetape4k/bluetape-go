...
// RedisRepository는 JWT key provider repository에서 caller-visible 상태와 의미를 설명한다.
...
// NewRedisRepository는 JWT key provider repository에서 생성과 초기화 계약을 설명한다.
...
// Current는 JWT key provider repository에서 반환값과 오류 의미를 설명한다.
...
// Find는 JWT key provider repository에서 반환값과 오류 의미를 설명한다.
...
// Rotate는 JWT key provider repository에서 반환값과 오류 의미를 설명한다.
...
// ForcedRotate는 JWT key provider repository에서 동작과 caller-visible 계약을 설명한다.
...
// DeleteAll는 JWT key provider repository에서 caller-visible 상태와 의미를 설명한다.
