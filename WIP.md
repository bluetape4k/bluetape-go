...
The milestone is in progress. Issue #56 starts the package with a
...
reconstruction. Repository, outbox, SQL/Redis/Kafka/NATS adapters, and example
services remain tracked by later `0.9.0` issues.
...
- `0.1.0`, `0.1.1`, `0.2.0`, `0.3.0`, `0.4.0`, `0.5.0`, `v0.5.1`,
  ...
  released.
- Milestone `0.9.0` is open. Issue #56 is the first implementation slice.
