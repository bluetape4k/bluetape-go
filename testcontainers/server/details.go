...
// ErrMissingDetail Testcontainers fixture에서 반환값과 오류 의미를 설명한다.
var ErrMissingDetail = errors.New("missing connection detail")

// ConnectionDetails Testcontainers fixture에서 caller-visible 상태와 의미를 설명한다.
type ConnectionDetails map[string]string

// Clone Testcontainers fixture에서 반환값과 오류 의미를 설명한다.
...
// Merge Testcontainers fixture에서 반환값과 오류 의미를 설명한다.
...
// Get Testcontainers fixture에서 반환값과 오류 의미를 설명한다.
func (d ConnectionDetails) Get(key string) (string, bool) {
	value, ok := d[key]
	return value, ok
}

// Require Testcontainers fixture에서 반환값과 오류 의미를 설명한다.
