...
const (
	...
	// DSNKey is the documented key for a MariaDB data source name.
	DSNKey = "mariadb.dsn"
)

// Start launches a MariaDB test container and returns its data source name.
...
// StartServer launches a MariaDB test container and returns the shared server view.
